...
export default async function NotFound() {
	...
	return (
		<div className="mx-auto max-w-2xl rounded-3xl border bg-[var(--surface-elevated)] p-8 text-center">
			...
			<Link
				href="/"
				className="mt-5 inline-block rounded-full bg-[var(--espresso)] px-5 py-2 text-sm font-semibold text-[var(--surface-elevated)]"
			>
