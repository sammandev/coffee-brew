	...
	return (
		<div className="space-y-6">
			<section className="rounded-3xl border bg-(--surface-elevated) p-6 sm:p-8">
				...
				<h2 className="mt-3 font-heading text-4xl text-(--espresso)">
			...
			<div className="grid gap-4 md:grid-cols-3">
				<Card>
					...
					<p className="mt-2 text-3xl font-bold text-(--espresso)">{(brewCount ?? 0).toLocaleString("en-US")}</p>
				</Card>
				<Card>
					<CardTitle>{locale === "id" ? "Total Thread" : "Total Threads"}</CardTitle>
					<p className="mt-2 text-3xl font-bold text-(--espresso)">{(threadCount ?? 0).toLocaleString("en-US")}</p>
				</Card>
				<Card>
					<CardTitle>{locale === "id" ? "Total Blog" : "Total Blog Posts"}</CardTitle>
					<p className="mt-2 text-3xl font-bold text-(--espresso)">{(blogCount ?? 0).toLocaleString("en-US")}</p>
				</Card>
			</div>
			...
			<div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
				<Link
					...
					className="rounded-3xl border bg-(--surface-elevated) p-6 transition hover:bg-(--surface) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/40"
				>
					<h3 className="font-heading text-2xl text-(--espresso)">{locale === "id" ? "Brew" : "Brews"}</h3>
				...
				<Link
					...
					className="rounded-3xl border bg-(--surface-elevated) p-6 transition hover:bg-(--surface) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/40"
				>
					<h3 className="font-heading text-2xl text-(--espresso)">{locale === "id" ? "Koleksi" : "Collections"}</h3>
					<CardDescription className="mt-2">
						{locale === "id"
				...
				<Link
					...
					className="rounded-3xl border bg-(--surface-elevated) p-6 transition hover:bg-(--surface) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/40"
				>
					<h3 className="font-heading text-2xl text-(--espresso)">{locale === "id" ? "Landing" : "Landing"}</h3>
					<CardDescription className="mt-2">
				...
				<Link
					...
					className="rounded-3xl border bg-(--surface-elevated) p-6 transition hover:bg-(--surface) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/40"
				>
					<h3 className="font-heading text-2xl text-(--espresso)">FAQ</h3>
					<CardDescription className="mt-2">
				...
				<Link
					...
					className="rounded-3xl border bg-(--surface-elevated) p-6 transition hover:bg-(--surface) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/40"
				>
					<h3 className="font-heading text-2xl text-(--espresso)">{locale === "id" ? "Moderasi" : "Moderation"}</h3>
					<CardDescription className="mt-2">
				...
				<Link
					...
					className="rounded-3xl border bg-(--surface-elevated) p-6 transition hover:bg-(--surface) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/40"
				>
					<h3 className="font-heading text-2xl text-(--espresso)">Blog CMS</h3>
					<CardDescription className="mt-2">
				...
				{session.role === "superuser" ? (
					<>
						<Link
							...
							className="rounded-3xl border bg-(--surface-elevated) p-6 transition hover:bg-(--surface) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/40"
						>
							<h3 className="font-heading text-2xl text-(--espresso)">RBAC</h3>
							<CardDescription className="mt-2">
						...
						<Link
							...
							className="rounded-3xl border bg-(--surface-elevated) p-6 transition hover:bg-(--surface) focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/40"
						>
							<h3 className="font-heading text-2xl text-(--espresso)">{locale === "id" ? "Pengguna" : "Users"}</h3>
							<CardDescription className="mt-2">
								{locale === "id"
