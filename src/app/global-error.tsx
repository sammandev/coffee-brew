	...
	return (
		<html lang="en">
			<body className="bg-background text-foreground">
				<div className="mx-auto grid min-h-screen w-full max-w-3xl place-items-center px-4 py-10">
					<div className="w-full rounded-3xl border bg-(--surface-elevated) p-6 text-center sm:p-8">
						...
						<h1 className="mt-2 font-heading text-4xl text-(--espresso)">Application Error</h1>
